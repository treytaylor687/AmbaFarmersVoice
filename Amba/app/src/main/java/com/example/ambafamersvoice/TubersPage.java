...
public class TubersPage extends AppCompatActivity {
    private static StorageReference storageRef = FirebaseStorage.getInstance().getReferenceFromUrl("gs://amba-farmers-voice-d1a51.appspot.com/tubers");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tubers_page);
        ...
        storageRef.listAll()
                .addOnSuccessListener(new OnSuccessListener<ListResult>() {
                    ...
                    public void onSuccess(ListResult listResult) {
                        ...
                        ScrollView sv = new ScrollView(TubersPage.this);
                        ...
                        LinearLayout ll = new LinearLayout(TubersPage.this);
                        ...
                        sv.addView(ll);
                        final TextView textView = new TextView(TubersPage.this);
                        textView.setText("Tubers Page");
                        textView.setTextSize(50);
                        ll.addView(textView);
                        if (listResult.getItems().size() == 0) {
                            final TextView textView1 = new TextView(TubersPage.this);
                        ...
                        for (StorageReference item : listResult.getItems()) {
                            ...
                            item.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    Button btn = new Button(TubersPage.this);
                                    ...
                                    btn.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            btn.startAnimation(AnimationUtils.loadAnimation(TubersPage.this,R.anim.shake));
                                            item.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                ...
                                                public void onSuccess(Uri uri) {
                                                    ...
                                                    downloadFile(TubersPage.this, fileName, "mp4", Environment.DIRECTORY_DOWNLOADS, url);
                                                }
                        ...
                        TubersPage.this.setContentView(sv);
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
