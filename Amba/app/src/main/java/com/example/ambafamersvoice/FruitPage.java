...
public class FruitPage extends AppCompatActivity {
    private static StorageReference storageRef = FirebaseStorage.getInstance().getReferenceFromUrl("gs://amba-farmers-voice-d1a51.appspot.com/fruits");
        ...
        storageRef.listAll()
                .addOnSuccessListener(new OnSuccessListener<ListResult>() {
                    ...
                    public void onSuccess(ListResult listResult) {
                        ...
                        ScrollView sv = new ScrollView(FruitPage.this);
                        ...
                        LinearLayout ll = new LinearLayout(FruitPage.this);
                        ...
                        sv.addView(ll);
                        final TextView textView = new TextView(FruitPage.this);
                        textView.setText("Fruit Page");
                        textView.setTextSize(50);
                        ll.addView(textView);
                        if (listResult.getItems().size() == 0) {
                            final TextView textView1 = new TextView(FruitPage.this);
                        ...
                        for (StorageReference item : listResult.getItems()) {
                            ...
                            item.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    Button btn = new Button(FruitPage.this);
                                    ...
                                    btn.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            btn.startAnimation(AnimationUtils.loadAnimation(FruitPage.this,R.anim.shake));
                                            item.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                ...
                                                public void onSuccess(Uri uri) {
                                                    ...
                                                    downloadFile(FruitPage.this, fileName, "mp4", Environment.DIRECTORY_DOWNLOADS, url);
                                                }
                        ...
                        FruitPage.this.setContentView(sv);
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
