...
public class AquaPage extends AppCompatActivity {
    private static StorageReference storageRef = FirebaseStorage.getInstance().getReferenceFromUrl("gs://amba-farmers-voice-d1a51.appspot.com/aqua-culture");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aqua_page);
        ...
        storageRef.listAll()
                .addOnSuccessListener(new OnSuccessListener<ListResult>() {
                    ...
                    public void onSuccess(ListResult listResult) {
                        ...
                        ScrollView sv = new ScrollView(AquaPage.this);
                        ...
                        LinearLayout ll = new LinearLayout(AquaPage.this);
                        ...
                        sv.addView(ll);
                        final TextView textView = new TextView(AquaPage.this);
                        textView.setText("Aqua Page");
                        textView.setTextSize(50);
                        ll.addView(textView);
                        if (listResult.getItems().size() == 0) {
                            final TextView textView1 = new TextView(AquaPage.this);
                        ...
                        for (StorageReference item : listResult.getItems()) {
                            ...
                            item.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    Button btn = new Button(AquaPage.this);
                                    ...
                                    btn.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            btn.startAnimation(AnimationUtils.loadAnimation(AquaPage.this,R.anim.shake));
                                            item.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                ...
                                                public void onSuccess(Uri uri) {
                                                    ...
                                                    downloadFile(AquaPage.this, fileName, "mp4", Environment.DIRECTORY_DOWNLOADS, url);
                                                }
                        ...
                        AquaPage.this.setContentView(sv);
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
