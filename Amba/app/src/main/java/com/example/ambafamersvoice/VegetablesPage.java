...
public class VegetablesPage extends AppCompatActivity {
    private static StorageReference storageRef = FirebaseStorage.getInstance().getReferenceFromUrl("gs://amba-farmers-voice-d1a51.appspot.com/vegetables");
        ...
        storageRef.listAll()
                .addOnSuccessListener(new OnSuccessListener<ListResult>() {
                    ...
                    public void onSuccess(ListResult listResult) {
                        ...
                        ScrollView sv = new ScrollView(VegetablesPage.this);
                        ...
                        LinearLayout ll = new LinearLayout(VegetablesPage.this);
                        ...
                        sv.addView(ll);
                        final TextView textView = new TextView(VegetablesPage.this);
                        textView.setText("Vegatables Page");
                        textView.setTextSize(50);
                        ll.addView(textView);
                        if (listResult.getItems().size() == 0) {
                            final TextView textView1 = new TextView(VegetablesPage.this);
                        ...
                        for (StorageReference item : listResult.getItems()) {
                            ...
                            item.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    Button btn = new Button(VegetablesPage.this);
                                    ...
                                    btn.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            btn.startAnimation(AnimationUtils.loadAnimation(VegetablesPage.this,R.anim.shake));
                                            item.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                ...
                                                public void onSuccess(Uri uri) {
                                                    ...
                                                    downloadFile(VegetablesPage.this, fileName, "mp4", Environment.DIRECTORY_DOWNLOADS, url);
                                                }
                        ...
                        VegetablesPage.this.setContentView(sv);
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
